                ...
                for (var i = 0; i < level.width; i++)
                {
                    for (var j = 0; j < level.height; j++)
                    {
                            ...
                            level.tiles[idx].elementType != ElementType.Ice)
                        {
                            ...
                            {
                                var x = left.GetComponent<Tile>().x;
                                var y = left.GetComponent<Tile>().y;
                                var idx2 = x + (y * level.width);
                                if (level.tiles[idx2].elementType != ElementType.Ice) {
                            ...
                            {
                                var x = right.GetComponent<Tile>().x;
                                var y = right.GetComponent<Tile>().y;
                                var idx2 = x + (y * level.width);
                                if (level.tiles[idx2].elementType != ElementType.Ice) {
                                    hasPlayableColorBomb = true;
                            ...
                            {
                                var x = top.GetComponent<Tile>().x;
                                var y = top.GetComponent<Tile>().y;
                                var idx2 = x + (y * level.width);
                                if (level.tiles[idx2].elementType != ElementType.Ice) {
                                    hasPlayableColorBomb = true;
                            ...
                            {
                                var x = bottom.GetComponent<Tile>().x;
                                var y = bottom.GetComponent<Tile>().y;
                                var idx2 = x + (y * level.width);
                                if (level.tiles[idx2].elementType != ElementType.Ice) {
                                    hasPlayableColorBomb = true;
